...
This independent Liberu module owns the provider-neutral **Genealogy Timeline** capability.
...
- Composer package: `liberusoftware/module-genealogy-timeline`
- Module installer name: `genealogy-timeline`
- Category: capability
